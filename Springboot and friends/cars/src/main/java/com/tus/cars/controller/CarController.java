...
public class CarController {
    ...
    public List<Car> getCarsByYearRange(@PathVariable int minYear, @PathVariable int maxYear) {
        return carRepository.findByManufacturerYearBetween(minYear, maxYear);
    }
}